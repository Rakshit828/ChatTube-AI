...
@auth_routes.post('/signup', response_model=UserResponseSchema, status_code=status.HTTP_201_CREATED)
...
@auth_routes.post('/login', response_model=TokensSchema, status_code=status.HTTP_200_OK)
async def login(
